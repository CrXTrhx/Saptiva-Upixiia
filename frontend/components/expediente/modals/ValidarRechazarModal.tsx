...
export default function ValidarRechazarModal({
  ...
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          className="flex max-h-[90dvh] w-full max-w-5xl flex-col overflow-hidden rounded-t-2xl bg-white sm:max-h-[85vh] sm:rounded-2xl"
        ...
        >
          ...
          {/* BODY */}
          <div className="grid flex-1 grid-cols-1 gap-6 overflow-y-auto p-4 sm:p-6 md:grid-cols-[280px_1fr]">
            {/* IZQUIERDA — preview */}
            <div className="min-w-0">
