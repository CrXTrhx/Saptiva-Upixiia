...
<img src="assets/banner.svg" alt="digitalfoldr — Saptiva AML Platform" width="100%">
...
| Deploy backend | Render (Docker) | API en producción |
| Deploy frontend | Cloudflare | Interfaz en producción |
...
| Frontend | Cloudflare Pages | Build de Next.js, variables `NEXT_PUBLIC_*` |
...
Proyecto privado — Saptiva. Todos los derechos reservados.
